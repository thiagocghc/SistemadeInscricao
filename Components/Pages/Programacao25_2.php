  ...
  <div id="sessaoDosCards">
        <div id="estiloTitulo">
            ...
            <div>
                ...
                <h2 id="tituloInsCon">25 de Outubro de 2022 às 20:30 hrs</h2>
            </div>
        </div>
    </div>
    ...
    <div class="wrapper">
        ...
        $sql = "SELECT palestrante.id_palestrante,palestrante.nome as nome_palestrante,palestrante.imagem,palestra.id_palestra,palestra.nome as palestra,palestra.descricao,palestra.vagas 
            ...
            WHERE palestrante.id_palestrante = palestra.id_palestrante and palestra.dia_palestra =2";
        ...
        if ($result) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $vagas = $row['vagas'];
                $buttonLink = '<a href="cadastro.php?palestra=' . $id_palestra . '&horario=2" class="btnPalestrante">Inscreva-se</a>';
